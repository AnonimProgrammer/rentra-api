...
public class UsernamePasswordAuthProvider implements AuthProvider {
  ...
  public UsernamePasswordAuthProvider(
      UserAuthRepository userAuthRepository, PasswordEncoder passwordEncoder) {
  ...
  public ExternalIdentity authenticate(Map<String, Object> credentials) {
    ...
    if (authEntry.getPasswordHash() == null
        || !passwordEncoder.matches(password, authEntry.getPasswordHash())) {
      throw new InvalidCredentialsException("Invalid username or password.");
    }

    String providerUserId =
        authEntry.getProviderUserId() == null ? identifier : authEntry.getProviderUserId();
