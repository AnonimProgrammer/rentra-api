...
public class VehicleService {
    ...
    private PageResponse<VehicleSummary> getVehiclesPage(
        ...
        List<VehicleEntity> vehicles = vehicleRepository.findVehicles(
                agencyId,
                EnumExtension.toName(request.category()),
                request.brand(),
                request.model(),
                EnumExtension.toName(request.transmission()),
                EnumExtension.toName(request.fuelType()),
                request.seatCount(),
                EnumExtension.toName(enforcedStatus),
                request.cursor(),
                pageLimit + 1);
